...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('author', sa.Column('asset', sa.INTEGER(), autoincrement=False, nullable=False))
    op.create_foreign_key('author_asset_fkey', 'author', 'asset', ['asset'], ['id'])
    op.add_column('asset', sa.Column('author', sa.VARCHAR(), autoincrement=False, nullable=True))
    # ### end Alembic commands ###
